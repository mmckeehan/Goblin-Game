...
var _upgrade_amount: float = ButtonGlobals.first_game_time_upgrade_amount
...
func _attack_up():
	var _current_upgrade_amount_count = ButtonGlobals.first_game_time_upgrade_count
